...
auth.onAuthStateChanged(async function (user) {
  ...
  if (user) {
    ...
    async function fetchVideos() {
        ...
        console.log("Total videos found:", querySnapshot.size);
        ...
        querySnapshot.forEach(async (doc) => {
          ...
          if (!userQuerySnapshot.empty) {
            ...
            // Create a container div for the video, caption, and user name
            ...
            likeButton.innerHTML =
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 11h3l-4-4-4 4h3v9h2v-9zm-7-9h-2v9H5l4 4 4-4h-3z"/></svg>';
      
            // Create the comment button
            const commentButton = document.createElement("button");
            commentButton.classList.add("comment-button");
            commentButton.innerHTML =
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M21 4H3a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6l3 4V18h6a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 14h-4V10h-2v8h-4v-8H7v8H3V6h18v12z"/></svg>';
      
            // Create the report button
            const reportButton = document.createElement("button");
            reportButton.classList.add("report-button");
            reportButton.innerHTML =
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12c0 2.93 1.19 5.57 3.11 7.48l1.42-1.42C6.41 15.37 5 13.79 5 12c0-3.86 3.14-7 7-7s7 3.14 7 7c0 1.79-1.41 3.37-3.53 3.46l1.42 1.42C20.81 17.57 22 14.93 22 12c0-5.52-4.48-10-10-10zm-1 14h2v2h-2v-2zm0-8h2v6h-2V8z"/></svg>';
